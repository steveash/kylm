...
public class SymbolSet implements Serializable {
     ...
     */
    public String[] getSymbols() { return syms.toArray(new String[0]); }
    ...
    public boolean equals(Object o) {
        ...
        if (ids != null ? !ids.equals(symbolSet.ids) : symbolSet.ids != null) return false;
        return syms != null ? syms.equals(symbolSet.syms) : symbolSet.syms == null;
    }

    @Override
    public int hashCode() {
        int result = ids != null ? ids.hashCode() : 0;
        result = 31 * result + (syms != null ? syms.hashCode() : 0);
        return result;
    }
