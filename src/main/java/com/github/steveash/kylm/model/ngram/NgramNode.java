...
//	}
    ...
    public boolean equals(Object o) {
        ...
        NgramNode ngramNode = (NgramNode) o;

        if (id != ngramNode.id) return false;
        if (count != ngramNode.count) return false;
        if (Float.compare(ngramNode.score, score) != 0) return false;
        return parent != null ? parent.equals(ngramNode.parent) : ngramNode.parent == null;
    }
