...
public abstract class LanguageModel implements Serializable {
    ...
    private void initializeVocab() {
        ...
        if (vocab != null && debug > 0)
            log.warn("WARNING: Resetting vocabulary, could cause alignment problems");
    ...
    public void importVocabulary(Iterable<String[]> sl) throws IOException {
        ...
        log.debug("LanguageModel.importVocabulary(): Vocab {} before trimming", counts.size());
        ...
        log.debug("LanguageModel.importVocabulary(): Finished with size {} for {}", vocab.getSize(), name);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (countTerminals != that.countTerminals) return false;
        if (maxLength != that.maxLength) return false;
        if (closed != that.closed) return false;
        if (vocabFrequency != that.vocabFrequency) return false;
        if (vocabLimit != that.vocabLimit) return false;
        if (ukModelCount != that.ukModelCount) return false;
        if (modelAllWords != that.modelAllWords) return false;
        ...
        if (terminalSymbol != null ? !terminalSymbol.equals(that.terminalSymbol) : that.terminalSymbol != null)
            return false;
        if (ukSymbol != null ? !ukSymbol.equals(that.ukSymbol) : that.ukSymbol != null) return false;
        // Probably incorrect - comparing Object[] arrays with Arrays.equals
        if (!Arrays.equals(ukModels, that.ukModels)) return false;
        if (classMap != null ? !classMap.equals(that.classMap) : that.classMap != null) return false;
        if (!Arrays.equals(wordEnts, that.wordEnts)) return false;
        if (!Arrays.equals(simpleEnts, that.simpleEnts)) return false;
        if (!Arrays.equals(unkEnts, that.unkEnts)) return false;
        return Arrays.equals(classEnts, that.classEnts);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (countTerminals ? 1 : 0);
        result = 31 * result + maxLength;
        result = 31 * result + (closed ? 1 : 0);
        result = 31 * result + (vocab != null ? vocab.hashCode() : 0);
        result = 31 * result + vocabFrequency;
        result = 31 * result + vocabLimit;
        result = 31 * result + (startSymbol != null ? startSymbol.hashCode() : 0);
        result = 31 * result + (terminalSymbol != null ? terminalSymbol.hashCode() : 0);
        result = 31 * result + (ukSymbol != null ? ukSymbol.hashCode() : 0);
        result = 31 * result + Arrays.hashCode(ukModels);
        result = 31 * result + ukModelCount;
        result = 31 * result + (modelAllWords ? 1 : 0);
        result = 31 * result + (classMap != null ? classMap.hashCode() : 0);
        result = 31 * result + Arrays.hashCode(wordEnts);
        result = 31 * result + Arrays.hashCode(simpleEnts);
        result = 31 * result + Arrays.hashCode(unkEnts);
        result = 31 * result + Arrays.hashCode(classEnts);
        return result;
    }
}
