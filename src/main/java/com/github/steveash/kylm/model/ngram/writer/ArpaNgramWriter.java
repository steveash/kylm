...
import com.github.steveash.kylm.writer.TextStreamClassMapWriter;
...
public class ArpaNgramWriter extends NgramWriter {
    ...
    public void write(NgramLM lm, OutputStream os) throws IOException {
        ...
        printOne("smooth_unigrams", "" + (lm.getSmoother() == null ? false : lm.getSmoother()
                .getSmoothUnigrams()), "false");
