...
public class KNSmoother extends AbsoluteSmoother {
    private static final Logger log = LoggerFactory.getLogger(KNSmoother.class);
    ...
    public void smooth(NgramLM lm) throws Exception {
        ...
        log.debug("KNSmoother: marking values to be trimmed");
        ...
        log.debug("KNSmoother: adjusting counts");
