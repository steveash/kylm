...
package com.github.steveash.kylm.model.ngram.reader;
...
import com.github.steveash.kylm.reader.TextStreamClassMapReader;
...
public class ArpaNgramReader extends NgramReader {
    ...
    public NgramLM read(BufferedReader br) throws IOException {
        ...
        while ((s = br.readLine()) != null && !s.equals(startOfData)) {
            if (s.length() == 0) { } else if (s.equals("[name]")) lm.setName(br.readLine());
