...
import com.github.steveash.kylm.model.ngram.smoother.AbsoluteSmoother;
import com.github.steveash.kylm.model.ngram.smoother.GTSmoother;
...
import com.github.steveash.kylm.model.ngram.smoother.MLSmoother;
import com.github.steveash.kylm.model.ngram.smoother.NgramSmoother;
import com.github.steveash.kylm.model.ngram.smoother.WBSmoother;
import com.github.steveash.kylm.model.ngram.writer.ArpaNgramWriter;
import com.github.steveash.kylm.model.ngram.writer.NgramWriter;
import com.github.steveash.kylm.model.ngram.writer.SerializedNgramWriter;
import com.github.steveash.kylm.model.ngram.writer.WFSTNgramWriter;
import com.github.steveash.kylm.reader.SentenceReader;
import com.github.steveash.kylm.reader.TextFileClassMapReader;
...
public class CountNgrams {
    ...
    private static NgramLM getUnknownModel(String str) {
        ...
        // get the model size
        int modelSize = 0;
        try { modelSize = Integer.parseInt(strs[1]); } catch (NumberFormatException e) {
        ...
        int nOrder = 2;
        if (strs.length > 3) {
            try { nOrder = Integer.parseInt(strs[3]); } catch (NumberFormatException e) {
